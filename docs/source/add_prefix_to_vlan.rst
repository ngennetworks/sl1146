...
* :ref:`add-prefix-vlan-v4`
* :ref:`add-prefix-vlan-v6`

------------------------------------

.. _add-prefix-vlan-v4:

Add IPv4 Address to VLAN Interface
==================================
...
Add IPv6 Address to VLAN Interface
==================================

In this exercise, we will be adding the documentation prefix "2001:DB8::1/48" to VLAN interface "ae0.100"; this is a LAG interface with a VLAN tag of 100.
...
3) Next, transition to configuration for ae0.100 and add 2001:DB8::1/48::
...
7) Validate that the IP address is now present on interface ae0.100::
    ...
    user@mx> show interfaces terse ae0.100
    Interface               Admin Link Proto    Local                 Remote
    ae0.100               up    up   inet6     2001:DB8::1/48
                                     multiservice
